...
void LTexture::render( GLfloat x, GLfloat y )
{
    ...
    if( mTextureID != 0 )
    {
        ...
        glBegin( GL_QUADS );
            ...
            glTexCoord2f( 1.f, 0.f ); glVertex2f(0.5f,0.0f);//glVertex2f( mTextureWidth/2,            0.f );
            glTexCoord2f( 1.f, 1.f ); glVertex2f(0.5f,0.5f);//glVertex2f( mTextureWidth, mTextureHeight );
            glTexCoord2f( 0.f, 1.f ); glVertex2f(0.f,0.5f);//glVertex2f(           0.f, mTextureHeight );
        glEnd();
    }
}
